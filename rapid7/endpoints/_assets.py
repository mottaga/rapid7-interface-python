...
def search_assets(self, search : list[SearchObject], sort : list[SortObject], 
                    index : int = None, size : int = None) -> dict:
    """ Search assets
    
    POST /v1/assets/_search

    https://help.rapid7.com/insightidr/en-us/api/v1/docs.html#tag/Assets/operation/searchAssets

    """
    
    method = "POST"
    url = "/v1/assets/_search"
...
def get_asset_by_rrn(self, rrn : str) -> dict:
    """ Get asset by rrn
    
    GET /v1/assets/[rrn]

    https://help.rapid7.com/insightidr/en-us/api/v1/docs.html#tag/Assets/operation/findByRrn_1
